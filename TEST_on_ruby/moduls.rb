...
# Модуль Math в стандартной библиотеке Ruby
print Math::PI, $/
#Если мы хотим прямо ссылаться на методы или константы модуля без использования ::, мы можем включить (include) нужный модуль
include Math
print  PI, $/
